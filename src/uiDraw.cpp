...
void ogstream::drawBoard()
{
   ...
   for (int col = 0; col < 8; col++)
   {
      ...
      // Bottom row
      GLfloat xPos =
         (GLfloat)SIZE_SQUARE +         // indent by the board margin
...
void ogstream::drawSelected(const Position &pos)
{
   ...
   // draw the square
   glVertex2i(
      (GLint)((col + 0) * SIZE_SQUARE + 3 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 3 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 3 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 3 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 3 + SIZE_SQUARE),
...
void ogstream::drawHover(const Position &pos)
{
   ...
   // draw the square
   glVertex2i(
      (GLint)((col + 0) * SIZE_SQUARE + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE + SIZE_SQUARE),
   ...
   // draw the square
   glVertex2i(
      (GLint)((col + 0) * SIZE_SQUARE + 2 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 2 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 2 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 2 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 2 + SIZE_SQUARE),
...
void ogstream::drawPossible(const Position &pos)
{
   ...
   // draw the square
   glVertex2i(
      (GLint)((col + 0) * SIZE_SQUARE + 7 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 7 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 7 + SIZE_SQUARE),
      (GLint)((row + 0) * SIZE_SQUARE + 7 + SIZE_SQUARE)
   );
   glVertex2i(
      (GLint)((col + 1) * SIZE_SQUARE - 7 + SIZE_SQUARE),
