...
{
   public:
      PieceSpy(int c, int r, bool f = true, PieceType pt = PieceType::SPACE) :
         PieceDummy(c, r, f), pt(pt)
      {
         numConstruct++;
      }
      PieceSpy(const PieceSpy &piece) : PieceDummy(piece), pt(PieceType::SPACE)
      {
         numCopy++;
      }
      ~PieceSpy() { numDelete++; }
...
class White : public PieceDummy
{
   ...
   public:
      White() : PieceDummy(), pt(PieceType::ROOK) {}
...
class Black : public PieceDummy
{
   ...
   public:
      Black() : PieceDummy(), pt(PieceType::ROOK) {}
